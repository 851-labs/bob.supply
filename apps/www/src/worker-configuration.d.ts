// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config .output/server/wrangler.json --env-interface CloudflareEnv` (hash: 9705bbbd6543e13a8b07938c466ca73d)
// Runtime types generated with workerd@1.20250310.0 2026-05-16 nodejs_compat
interface CloudflareEnv {
	BOB_SUPPLY_BUCKET: R2Bucket;
	ASSETS: Fetcher;
}
